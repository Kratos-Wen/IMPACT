...
GPU_LIST="${4:-0}"
SPLIT_NAME="${5:-split1}"
RUN_TAG="${6:-avt_${FEATURE_TYPE}_${VIEW}_${SPLIT_NAME}}"

ROOT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")/../../../.." && pwd)"
ANNOTATION_DIR="${7:-$ROOT_DIR/dataset/AF-S/Annotation}"
OUTPUT_ROOT="${8:-$ROOT_DIR/outputs/af_s/avt}"
LOG_ROOT="${9:-$ROOT_DIR/logs/af_s/avt}"
...
echo "[Done] AVT AF-S training finished. Log: $LOG_PATH"
