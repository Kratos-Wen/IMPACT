...
IMPACT_ROOT="${5:-$ROOT_DIR/dataset/ATR}"
OUTPUT_BASE="${6:-$ROOT_DIR/outputs/atr/ltcontext}"
LOG_BASE="${7:-$ROOT_DIR/logs/atr/ltcontext}"
...
case "$TASK_MODE" in
  ...
  *)
    ...
    echo "Expected one of: ATR_L, ATR_R"
    exit 1
    ;;
esac
...
CFG_PATH="$ROOT_DIR/tasks/ATR/ltcontext/configs/${CFG_SLUG}.yaml"
