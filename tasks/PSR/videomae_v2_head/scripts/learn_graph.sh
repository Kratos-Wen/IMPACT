...
OUTPUT_PATH="${2:-$ROOT_DIR/outputs/psr/videomae_v2_head/procedure_graph_split${SPLIT_ID#split}.json}"
ALIAS_MAP="${3:-$ROOT_DIR/tasks/PSR/videomae_v2_head/configs/component_alias.json}"
ANNOTATION_DIR="${4:-$ROOT_DIR/dataset/ASR/annotations}"
SPLIT_DIR="${5:-$ROOT_DIR/dataset/ASR/splits_front_only_v1}"
LOG_BASE="${6:-$ROOT_DIR/logs/psr/videomae_v2_head}"
...
cd "$ROOT_DIR/third_party/videomae_v2_head"
PYTHONUNBUFFERED=1 \
