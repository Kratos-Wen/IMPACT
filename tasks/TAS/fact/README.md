...
```bash
bash tasks/TAS/fact/scripts/train_splits.sh TAS-S videomaev2 0,1,2,3 exp_tas_fact
```

```bash
bash tasks/TAS/fact/scripts/eval_checkpoint.sh TAS-S videomaev2 1 0 /path/to/network.iter-100000.net
```
