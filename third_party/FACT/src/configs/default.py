...
_C.skip_missing_features = False # whether to skip videos without feature files

# IMPACT-specific convenience switches (used when dataset == "IMPACT")
_C.impact_root = None
_C.impact_task = "CAS" # one of CAS, FAS_L, FAS_R, PPR_L, PPR_R, ATR_L, ATR_R
_C.impact_feature_type = "videomaev2" # one of videomaev2, i3d
