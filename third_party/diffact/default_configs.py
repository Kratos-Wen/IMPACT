...
params_ego4exo = {
   ...
   "diffusion_params":{
      ...
      "ddim_sampling_eta":1.0,
      "snr_scale":1.0,
      "cond_types":  ['full', 'zero', 'boundary05-', 'segment=2', 'segment=2'],
     "detach_decoder": False,
   },
   "loss_weights":{
      "encoder_ce_loss":0.5,
...
for split_id in range(1, split_num+1):
    ...
    params = copy.deepcopy(params_ego4exo)

    params['split_id'] = split_id
    params['naming'] = f'Ego4Exo-Trained-S{split_id}'
