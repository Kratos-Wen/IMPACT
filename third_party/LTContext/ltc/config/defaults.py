...
# Dataset [breakfast, assembly101, ego4exo_front, impact].
...
# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to split bundles
_C.DATA.SPLITS_DIR = "splits"

# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to frame-wise labels
_C.DATA.GROUND_TRUTH_DIR = "groundTruth"

# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to ATR frame-valid masks
_C.DATA.MASK_DIR = ""

# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to ATR segment manifests
_C.DATA.ATR_SEGMENTS_DIR = ""

# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to extracted features
_C.DATA.FEATURES_DIR = "features"

# relative (to DATA.PATH_TO_DATA_DIR) or absolute path to mapping file
_C.DATA.MAPPING_FILE = "mapping.txt"

# task type: ["segmentation", "atr"]
_C.DATA.TASK_TYPE = "segmentation"

# feature type: ["auto", "i3d", "videomaev2"]
_C.DATA.FEATURE_TYPE = "auto"

# skip videos without matched feature files
_C.DATA.SKIP_MISSING_FEATURES = False
